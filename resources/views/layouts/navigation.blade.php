...
@can('view_dashboard')
    <x-nav.link route="admin.centers" icon="fas fa-home">{{ __('Centers') }}</x-nav.link>
@endcan

@can('view_dashboard')
    <x-nav.link route="admin.assets" icon="fas fa-home">{{ __('Assets') }}</x-nav.link>
@endcan

@can('view_dashboard')
    <x-nav.link route="admin.locations" icon="fas fa-home">{{ __('Location') }}</x-nav.link>
@endcan

@can('view_dashboard')
    <x-nav.link route="admin.categories" icon="fas fa-home">{{ __('Categories') }}</x-nav.link>
@endcan
