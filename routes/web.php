...
use App\Http\Livewire\Admin\Asset\Asset;
...
use App\Http\Livewire\Admin\Center\Center;
use App\Http\Livewire\Admin\Location\Location;
...
Route::prefix(config('admintw.prefix'))->middleware(['auth', 'verified', 'activeUser', 'IpCheckMiddleware'])->group(function () {
    ...
    Route::prefix('assets')->group(function () {
        Route::get('/', Asset::class)->name('admin.assets');
    });

    Route::prefix('categories')->group(function () {
        Route::get('/', CategoryIndex::class)->name('admin.categories');
    });
    Route::prefix('centers')->group(function () {
        Route::get('/', Center::class)->name('admin.centers');
    });
    Route::prefix('locations')->group(function () {
        Route::get('/', Location::class)->name('admin.locations');
    });
